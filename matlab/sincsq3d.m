...
wtrans=(1/64)*finufft3d3(allxx,allyy,allzz,h_at_xxyyzz.*allww,1,newtol,a1,a2,a3);  
else
...
tic;correct=superslowsincsq3d(ifl,a1(1:numeval),a2(1:numeval),a3(1:numeval),klocs_d1,klocs_d2,klocs_d3,q);t3=toc;
